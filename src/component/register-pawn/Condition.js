            ...
            <div style={{margin : "30px 55px"}} className="truyen-thong-ct main-section" >
                <div className="main-content"><h2 style={{  textAlign: "center",fontFamily: "Times New Roman", fontSize: "29px" }} className="uk-text-center title-newss"> ĐIỀU KHOẢN THI HÀNH ÁP DỤNG CHO HỢP
                    ...
                    <p  className="term-content"><strong>1.</strong> Tại bất kỳ thời điểm nào chưa đến kỳ cầm đồ, lãi và
                        ...
                        className="term-content"><strong>7.</strong> Thanh toán phạt vi phạm và/hoặc bồi thường thiệt hại:
                        ...
                        Bên căn cứ trên nợ gốc mới. Trường hợp tại thời điểm đến hạn thực hiện nghĩa vụ thanh toán, khoản
                        tiền Khách hàng đã thanh toán sau khi khấu trừ đi nghĩa vụ phải thanh toán tại Hợp đồng vẫn còn dư
                    ...
                    <div style={{paddingLeft : "25px"}} className="term-line-sub">
                        ...
                        (ngoại trừ Pawn Shop) có bất kỳ quyền hạn chế quyền sở hữu nào đối với tài sản cầm cố và các thông tin
                        cung cấp cho Pawn Shop để thực hiện Hợp đồng là thông tin trung thực và chính xác; </p> <p
                        className="term-content"><strong>iv.</strong> Đảm bảo tất cả giấy tờ về tài sản cầm cố Khách hàng
                        cung cấp cho Pawn Shop là bản gốc. Trong trường hợp là bản sao, là bản sao đúng và đầy đủ của bản gốc;
                    </p> <p className="term-content"><strong>v.</strong> Hoàn toàn chịu trách nhiệm trước pháp luật và các
                        bên liên quan khác về việc cầm cố tài sản tại Pawn Shop; </p> <p className="term-content">
                        <strong>vi.</strong> Khách hàng có nghĩa vụ nhận lại tài sản cầm cố và/hoặc tài liệu liên quan (nếu
                        có) trong vòng 07 (bảy) ngày kể từ ngày Khách hàng hoàn thành mọi nghĩa vụ thanh toán theo quy định
                        tại Hợp đồng cho Pawn Shop. Quá thời hạn trên, nếu Khách hàng không đến nhận lại tài sản và tài liệu liên
                        quan, Pawn Shop không chịu trách nhiệm với bất kỳ rủi ro nào liên quan đến tài sản và tài liệu đó. Pawn Shop có
                        quyền gửi chuyển phát tài sản và các tài liệu liên quan cho Khách hàng hoặc Người liên hệ theo thông
                        tin liên hệ mà Khách hàng đã cung cấp với cước phí vận chuyển do Khách hàng hoặc Người liên hệ chịu.
                    ...
                    <p  style={{fontSize: "18px",fontWeight : "300"}} className="term-content">
                        ...
                        Phạm: </strong></p>
                    <div style={{marginLeft : "25px"}} className="term-line-sub"><p className="term-content"><strong>i.</strong> Khách hàng không tuân thủ
                        bất kỳ quy định nào của Hợp đồng và các Phụ lục kèm theo (nếu có), bao gồm nhưng không giới hạn việc
                        không thanh toán bất kỳ khoản đến hạn nào theo quy định của Hợp đồng; </p> <p
                        ...
                        nghiêm trọng đến tình hình tài chính hoặc tình hình trả nợ gốc, tiền lãi, chi phí vay, các khoản
                        phạt và các loại phí khác quy định tại Hợp đồng. </p></div>
                    <p style={{fontSize: "18px",fontWeight : "300"}} className="term-content"><strong> 2. Khi và tại bất kỳ thời điểm nào sau khi xảy ra và tiếp diễn một
                        Sự Kiện Vi Phạm quy định nêu trên và trong Hợp đồng, Pawn Shop có quyền, nhưng không có nghĩa vụ, ngay lập
                        tức: </strong></p>
                    <div  style={{marginLeft:"25px"}} className="term-line-sub"><p className="term-content"><strong>i.</strong> Tuyên bố đến hạn thanh
                        toán ngay toàn bộ hoặc bất cứ khoản tiền nào mà Khách hàng có nghĩa vụ thanh toán theo quy định của
                        Hợp đồng; </p> <p className="term-content"><strong>ii.</strong> Chấm dứt tất cả các nghĩa vụ của Pawn Shop
                        theo Hợp đồng và các văn bản liên quan; </p> <p className="term-content"><strong>iii.</strong> Thực
                    ...
                    <p style={{fontSize: "18px",fontWeight : "300"}} className="term-content"><em> <strong> 1. Áp dụng với sản phẩm cầm cố xe máy và ô tô </strong> </em>
                        ...
                        hàng phải bàn giao ngay lập tức tài sản cầm cố theo yêu cầu của Pawn Shop tại bất kỳ thời điểm nào. Việc
                        hao mòn tài sản cầm cố khi Khách hàng lưu giữ tài sản cầm cố sẽ được coi như là việc giảm sút giá
                        trị tài sản cầm cố, tỷ lệ hao mòn sẽ do Pawn Shop toàn quyền quyết định. </p> <p className="term-content">
                        <em> <strong style={{fontSize: "18px",fontWeight : "400"}}>2. Đăng ký biện pháp bảo đảm</strong> </em></p> <p className="term-content"> Để thực
                        hiện Hợp đồng và các Phụ lục (nếu có), các Bên thỏa thuận và đồng ý rằng Pawn Shop có quyền yêu cầu Khách
                        hàng đăng ký biện pháp bảo đảm và duy trì, không thực hiện bất kỳ thay đổi nào đối với giao dịch bảo
                        ...
                        liệu theo quy định của pháp luật, được Pawn Shop ký bằng chữ ký số có chứng thực và Khách hàng ký bằng chữ
                        ký điện tử, có đầy đủ giá trị pháp lý và đã cấu thành mọi điều kiện cần thiết để có đầy đủ giá trị
                        pháp lý như bản gốc Hợp đồng. Chữ ký số của Pawn Shop và chữ ký điện tử của Khách hàng có giá trị pháp lý
                        thay cho chữ ký trực tiếp ký bằng tay và con dấu của Pawn Shop, và chữ ký trực tiếp bằng tay và con dấu
                        (trong trường hợp Khách hàng là doanh nghiệp hoặc tổ chức khác có con dấu) của Khách hàng trên văn
                        bản giấy. Khách hàng đồng ý, xác nhận, cam kết và bảo đảm rằng: </p>
                    <div style={{marginLeft:"25px"}} className="term-line-sub"><p className="term-content"><strong>i.</strong> Đã được Pawn Shop cung cấp đầy
                        đủ thông tin liên quan đến việc giao kết Hợp đồng dưới hình thức hợp đồng điện tử bằng phương tiện
                        điện tử; Đã hiểu rõ và tự nguyện giao kết Hợp đồng dưới hình thức này; </p> <p
                        className="term-content"><strong>ii.</strong> Đã được Pawn Shop cung cấp đầy đủ thông tin liên quan đến
                        quy trình giao kết, ký kết Hợp đồng bằng chữ ký điện tử của Khách hàng và chữ ký số của Pawn Shop, bao gồm
                        cả quy trình kiểm tra an toàn của chữ ký điện tử. Khách hàng hiểu rõ và đồng ý với các quy trình
                        này; </p> <p className="term-content"><strong>iii.</strong> Đồng ý sử dụng số điện thoại và/hoặc
                        email đã cung cấp cho Pawn Shop để nhận các thông tin cho mục đích ký kết Hợp đồng, bao gồm nhưng không
                        giới hạn địa chỉ liên kết (link address), mã đăng nhập (nếu có), mã xác thực (OTP) để thực hiện ký
                        kết; địa chỉ liên kết (link address) và mật khẩu (nếu có) để truy cập và xem lại các văn bản đã ký
                        kết thành công; </p> <p className="term-content"><strong>iv.</strong> Để phục vụ cho mục đích ký kết
                        Hợp đồng bằng chữ ký điện tử, tự kiểm soát việc sử dụng số điện thoại, phương tiện điện tử của mình,
                        mã đăng nhập (nếu có), mã xác thực (OTP) và mật khẩu (nếu có) được cung cấp; chịu trách nhiệm trong
                        trường hợp không đảm bảo việc kiểm soát được quy định tại mục này; </p> <p  className="term-content">
                        <strong>v.</strong> Bằng việc ký kết Hợp đồng này dưới hình thức hợp đồng điện tử bằng chữ ký điện
                        tử, Khách hàng đương nhiên thừa nhận hiệu lực thi hành và giá trị pháp lý của Hợp đồng, và sẽ không
                        có bất kỳ khiếu nại, khởi kiện nào về hiệu lực thi hành và giá trị pháp lý của Hợp đồng vì lý do Hợp
                        đồng được giao kết theo hình thức hợp đồng điện tử và/hoặc chữ ký của các Bên là chữ ký điện tử và
                        chữ ký số. </p></div>
                    <p className="term-content"> Trong trường hợp Khách hàng ký Hợp đồng điện tử bằng chữ ký số, ngoài các
                        nội dung trên, Khách hàng đồng ý và xác nhận thêm rằng: </p>
                    <div style={{marginLeft:"25px"}} className="term-line-sub"><p className="term-content"><strong>i.</strong> Đồng ý chữ ký số và chứng
                        thư số của Khách hàng sẽ được cung cấp bởi đơn vị cung cấp dịch vụ chứng thực chữ ký số công cộng do
                        Pawn Shop lựa chọn và sử dụng từng thời kỳ; </p> <p className="term-content"><strong>ii.</strong> Đồng ý
                    ...
                    <p className="term-content"> Khách hàng đồng ý rằng Pawn Shop sẽ không bán, chia sẻ thông tin của Khách hàng
                        ...
                        hợp: </p>
                    <div style={{marginLeft:"25px"}} className="term-line-sub"><p className="term-content"><strong>i.</strong> Cung cấp cho cơ quan nhà
                        nước có thẩm quyền; </p> <p className="term-content"><strong>ii.</strong> Cung cấp cho các đơn vị có
                        chức năng cung cấp dịch vụ thông tin tín dụng và/hoặc đánh giá tín nhiệm hoạt động hợp pháp tại Việt
                        Nam; </p> <p className="term-content"><strong>iii.</strong> Cung cấp cho các chủ nợ, nhà đầu tư, bên
                        tư vấn chuyên nghiệp của Pawn Shop và các bên có hợp tác hoặc cung cấp dịch vụ với Pawn Shop để phát triển, cung
                        cấp hoặc liên quan đến việc cung cấp các sản phẩm, dịch vụ của Pawn Shop theo yêu cầu hợp lý với điều kiện
                        Pawn Shop đã ký kết điều khoản về bảo mật thông tin với các đơn vị này. </p> <p className="term-content">
                        <strong>iv.</strong> Cung cấp cho người liên hệ trong trường hợp Khách hàng vi phạm hoặc có nguy cơ
                        sẽ vi phạm nghĩa vụ của Hợp đồng nhằm mục đích hỗ trợ thực hiện đúng Hợp đồng. </p> <p
                    ...
                    <p className="term-content"><strong>1. </strong>Các Bên thống nhất đồng ý rằng địa chỉ, số điện thoại và
                        ...
                        được thông báo của Pawn Shop khi Pawn Shop đã gửi thông báo tới địa chỉ, số điện thoại, email của Khách hàng
                        hoặc niêm yết tại các điểm giao dịch của Pawn Shop hoặc đã thông báo công khai trên website của Pawn Shop. Pawn Shop
                        không có nghĩa vụ xác minh việc Khách hàng đã nhận được các thông báo này. Trong trường hợp Khách
                        hàng có sự thay đổi địa chỉ, số điện thoại, email liên hệ thì phải thông báo cho Pawn Shop bằng văn bản;
                        nếu không thông báo thì Pawn Shop có quyền gửi thông báo, thông tin đến địa chỉ, số điện thoại, email do
                        Khách hàng cung cấp trước đó và mặc nhiên coi như Khách hàng đã nhận được các thông báo, thông tin
                        này, và các thông báo, thông tin này có giá trị ràng buộc với Khách hàng. </p> <p
                    ...
                    <p style={{fontSize:"20px",fontWeight:"400"}} className="term-content"> Tại Pawn Shop, chúng tôi trân trọng và vun đắp mối quan hệ với khách hàng. Chúng
                        tôi cam kết “Cho vay có trách nhiệm” bằng cách đảm bảo đem đến cho khách hàng dịch vụ chuyên nghiệp
                        cùng sản phẩm cho vay bền vững giúp khách hàng hiện thực hóa nhu cầu của mình. Với tất cả mọi khách
                        hàng đến với Pawn Shop, chúng tôi luôn cố gắng hết mực để đem lại chất lượng dịch vụ như sau: </p> <p
                        style={{fontSize: "18px",fontWeight : "400"}}  className="term-content"><strong>1. </strong>Nhanh chóng: Chúng tôi thấu hiểu và coi trọng thời gian
                        quý báu của khách hàng. Nhân viên Pawn Shop luôn tìm mọi cách rút ngắn thời gian giao dịch và đơn giản hóa
                        thủ tục cho khách hàng. </p> <p style={{fontSize: "18px",fontWeight : "400"}} className="term-content"><strong>2. </strong>Thân thiện: Nhân viên
                        Pawn Shop được đào tạo bài bản để tiếp đón mọi khách hàng với thái độ lịch sự, vui tươi và tích cực. </p>
                    <p style={{fontSize: "18px",fontWeight : "400"}} className="term-content"><strong>3. </strong>Lắng nghe trọn vẹn: Nhân viên Pawn Shop luôn tôn trọng và lắng
                        nghe khách hàng. Chúng tôi hiểu rằng mọi ý kiến của khách hàng từ góp ý cho đến khiếu nại phàn nàn
                        đều là những cơ hội tuyệt vời để Pawn Shop cải tiến sản phẩm dịch vụ ngày càng tốt hơn. </p> <p
                        style={{fontSize: "18px",fontWeight : "400"}} className="term-content"><strong>4. </strong>Minh bạch: Mọi khách hàng đến với Pawn Shop đều được tư vấn
                        đầy đủ mọi thông tin về khoản vay trước khi tiến hành giao dịch. Pawn Shop cũng thông báo trước cho khách
                        hàng khi đến kỳ thanh toán chi phí vay hoặc tất toán khoản vay. </p> <p style={{fontSize: "18px",fontWeight : "400"}} className="term-content">
                        <strong>5. </strong>Bảo mật thông tin: Chúng tôi tuyệt đối bảo đảm thông tin về khách hàng không
                        được chia sẻ cho bất kỳ bên thứ ba nào khác (trừ trường hợp theo quy định Mục VI Điều khoản thi
                        hành). </p> <p style={{fontSize: "18px",fontWeight : "400"}}  className="term-content"><strong>6. </strong>An toàn: Mọi tài sản và giấy tờ của
                        khách hàng được bảo quản an toàn tuyệt đối tại hệ thống kho bãi tiêu chuẩn quốc tế của Pawn Shop. Trong
                        trường hợp xảy ra rủi ro với tài sản khách hàng đang cầm cố tại Pawn Shop, Pawn Shop chịu hoàn toàn trách nhiệm
                        bồi thường thiệt hại. </p> <p style={{fontSize:"20px",fontWeight:"400"}} className="term-content"><strong>Chúng tôi tuyệt đối ngăn cấm những
                        hành vi sau trong dịch vụ khách hàng:</strong></p> <p style={{fontSize: "18px",fontWeight : "400"}}   className="term-content"><strong>1. </strong>Có
                        lời nói, hành động thiếu tôn trọng khách hàng. </p> <p  style={{fontSize: "18px",fontWeight : "400"}} className="term-content"><strong>2. </strong>Phân
                        biệt đối xử với khách hàng về giới tính, chủng tộc, độ tuổi, tôn giáo. </p> <p
                        style={{fontSize: "18px",fontWeight : "400"}}  className="term-content"><strong>3. </strong>Mọi hành vi tiết lộ thông tin cá nhân của khách hàng
                        hoặc sử dụng tài sản của khách hàng dưới mọi hình thức khi chưa có sự đồng ý từ khách hàng. </p>
                </div>
            </div>
